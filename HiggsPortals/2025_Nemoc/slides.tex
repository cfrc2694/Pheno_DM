...
\institute[NEMO-C 2025]{\inst{1} Universidad de los Andes\and
...
\begin{frame}{Statistical Significance}
    ...
    \begin{equation}
        \kappa = \frac{\sum_i s_i w_i}{\sqrt{\sum_i (s_i + b_i + \delta_{sys}^2) w_i^2}}
        =\frac{\sum_i \textcolor{orange}{\sigma_{s_i}} \textcolor{red}{\epsilon_{s_i}} \textcolor{purple}{w_i}}{\sqrt{\sum_i (\textcolor{orange}{\sigma_{s_i}}\textcolor{red}{\epsilon_{s_i}} + \sigma_{b_i}\textcolor{red}{\epsilon_{b_i}} + \textcolor{green}{\delta_{\sigma_{sys}}^2}) \textcolor{purple}{w_i}^2}}\sqrt{\textcolor{blue}{\mathcal L}}
    \end{equation}
    We can
    \begin{itemize}
...
\begin{frame}{Projections on the Higgs-to-invisible decay}
    ...
    \begin{equation}
         \frac{\sum_i \sigma_{s_i} \epsilon_{s_i} w_i}{\sqrt{\sum_i (\sigma_{s_i}\epsilon_{s_i} + \sigma_{b_i}\epsilon_{b_i} + \delta_{\sigma_{sys}}^2) w_i^2}}
         =
         \frac{\sum_i \sigma_{s_i}^{\text{VBF}}(\text{BR}) \epsilon_{s_i} w_i}{\sqrt{\sum_i (\sigma_{s_i}^{\text{VBF}}(\text{BR})\epsilon_{s_i}  + \sigma_{b_i}\epsilon_{b_i} + \delta_{\sigma_{sys}}^2) w_i^2}}
