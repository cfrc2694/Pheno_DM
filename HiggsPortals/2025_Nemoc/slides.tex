...
%         \begin{itemize}
%             \item Populates the universe with non-baryonic matter.
%             \item It is near to the 25\% of the total energy density of the universe.
%             \item Mainly cold, non-relativistic, and weakly or feably interacting (massive).
%             \item It is ``invisible'' to the standard detection methods.
%         \end{itemize}
%     \end{minipage}
%     \hfill
...
%     % \vfill
%     \begin{center}
%         \includegraphics[width=0.7\textwidth]{../Images/Higgs_portal.png}
%     \end{center}
% \end{frame}
...
\begin{frame}{The VBF Jets are boosted with High-PT signatures}
...
\begin{frame}{The VBF Jets have a large invariant mass}
    \begin{minipage}{0.97\textwidth}
...
\begin{frame}{The VBF Jets are forward}
    \begin{minipage}{0.97\textwidth}
...
\begin{frame}{The VBF Jets are in opposite longitudinal hemispheres}
    \includegraphics[width=\textwidth]{../Images/eta_product_comparison.pdf}
\end{frame}

\begin{frame}{The VBF Jets have a large Delta-$\eta$ separation}
    \includegraphics[width=\textwidth]{../Images/delta_eta_comparison.pdf}
\end{frame}

\begin{frame}{The VBF Jets are not back-to-back}
...
\begin{frame}{All the cuts suppres the background}
    \includegraphics[width=\textwidth]{../Images/met_comparison_after_vbf_cuts.pdf}
\end{frame}
...
\begin{frame}{Projections on the Higgs-to-invisible decay}
    ...
    \begin{itemize}
        ...
        \item With the HL-LHC, the promised integrated luminosity is 3 ab$^{-1}$, which will allow us to improve the sensitivity to $\text{BR}(H \to \text{inv}) < 0.008 = \mathcal{O}(10^{-2})$.
